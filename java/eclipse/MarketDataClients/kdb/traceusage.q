...
/.z.pg:{.z.execute[x]} / works perfectly! but no tracelog. 

/ This is the one i was after!!
.z.pg:{.usage.trace[`pg;.z.p;@[x;y;.usage.tracee[`pg;.z.p;y;]];y;.z.p]}.z.execute

/ These did not work.remember them!!
/.z.pg:{t:.z.execute[x];.usage.trace[`pg;.z.p;@[x;y;.usage.tracee[`pg;.z.p;y;]];y;.z.p];t}
/.z.pg:{.usage.trace[`pg;.z.p;@[x;y;.usage.tracee[`pg;.z.p;y;]];y;.z.p]}[.:]
