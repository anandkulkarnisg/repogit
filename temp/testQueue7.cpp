...
int main(int argc, char* argv[])
{
	...
	//vector<int> items = { 7, 7, 7, 7, 8, 6, 8, 9, 10, 11 }; // works!
	//vector<int> items = { 7, 7, 7, 7, 7, 7, 7, 7, 7, 7 }; // works!
	//vector<int> items = { 7, 7, 7, 7, 11, 8, 7, 7, 7, 10 }; // works!
	//vector<int> items = { 1, 7, 7, 7, 7, 8, 7, 7, 7, 7 }; // works!
	vector<int> items = { 13, 7, 7, 7, 14, 8, 9, 10, 11, 12 };
